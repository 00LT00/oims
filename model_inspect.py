...
flags.DEFINE_string('model_name', 'efficientdet-d3', 'Model.')
...
flags.DEFINE_string('ckpt_path', 'tmp/output-1', 'checkpoint dir used for eval.')
flags.DEFINE_string('export_ckpt', None, 'Path for exporting new models.')

flags.DEFINE_string(
    'hparams', 'num_classes=3', 'Comma separated k=v pairs of hyperparameters or a module'
    ' containing attributes to use as hyperparameters.')

flags.DEFINE_string('input_image', 'test_img/*.jpg', 'Input image path for inference.')
flags.DEFINE_string('output_image_dir', 'output_txt/', 'Output dir for inference.')
...
flags.DEFINE_float('min_score_thresh', 0.7, 'Score threshold to show box.')
